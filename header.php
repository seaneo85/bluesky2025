      ...
      <div class="content-container">
        <div class="header-contact-info">
          ...
          <span class="email">
            ...
            <a href="mailto:sales@blueskyland.net">sales@blueskyland.net</a>
          </span>
          <span class="address">
            <i class="fas fa-map-marker-alt"></i>
            362 North Park Street, Sykesville, PA 15865
          </span>
        </div>
      </div>
    </div>
      ...
      <div class="content-container">
        <div id="logo-container">
          <a href="<?php echo home_url() ?>/" title="<?php bloginfo( 'name' ) ?>" rel="home" class="logo">
            <img src="<?php echo get_template_directory_uri(); ?>/images/blueksy-logo-no-sign-2025.png" alt="<?php bloginfo( 'name' ) ?>" />
