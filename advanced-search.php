			...
			<form method="get" action="<?php echo home_url('/listings'); ?>" class="wpv-filter-form">
				<div class="search-inputs select-inputs">
					<div class="drop">
						...
						<select name="listing-type" id="wpv_control_select_property-type" class="wpcf-form-select form-select select" onchange="this.form.submit()" aria-describedby="property-type-help">
